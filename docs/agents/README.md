...
- 根目录 `README.md` 存放公开的 Package 使用文档。
...
- 仓库维护的 skill、reference 和 overlay 使用中文；命令、路径、代码标识、API
...
- `submit-pr` 的仓库、base、remote 与 Issue 策略按 `docs/agents/git-workflow.md` 确定，
  不继承源仓库的固定 `dev` 分支或发布政策。
